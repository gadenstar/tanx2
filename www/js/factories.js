/* 
* @Author: tanx
* @Date:   2015-12-31 09:49:31
* @Last Modified by:   tanx
* @Last Modified time: 2016-01-10 17:09:36
*/
...
// WP CATEGORIES
.factory('Categories', function($rootScope,$http, $q, WP_API2,WP_API,WC_API,WC_CK,WC_CS){

  return {
    getCategories: function() {
      var deferred = $q.defer();
     //$http.get(WP_API2 + 'get_category_index')
     ...
     // $http.jsonp(WP_API2 + 'get_category_index/' +
     //  '?callback=JSON_CALLBACK')
      .success(function(data) {
        deferred.resolve(data.product_categories);
       console.log (WC_API)
      
      })
      .error(function(data) {
        deferred.reject(data.product_categories);
      });
    ...
    getLists: function() {
     ...
     //$http.get(WP_API2 + 'get_category_index')
     //$http.get(WP_API + 'categories/')
     var categoryId2 = $rootScope.categoryId;
     $http.get(WC_API + 
