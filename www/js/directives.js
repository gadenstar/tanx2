/* 
* @Author: tanx
* @Date:   2016-01-04 15:06:22
* @Last Modified by:   tanx
* @Last Modified time: 2016-01-07 16:27:07
*/
...
.directive('pushMenu', function(){
  return {
    ...
    templateUrl: 'templates/common/main-menu.html',
    restrict: 'E',
    replace: true,
    transclude: true
  };
})
.directive('catLists', function(){
  return {
    scope: {
      menu: '=',
      level: '='
    ...
    templateUrl: 'templates/common/cat-lists.html',
    restrict: 'E',
    replace: true,
    transclude: true
  };
...
.directive('brandLists', function(_){
  return {
    scope: {
      menu: '=',
      level: '='
    ...
    link: function(scope, element, attr, menuCtrl) {
      ...
      scope._closeMenu = function(level){
        ...
        this._setTransform('translate3d(0,100%,0)', level);
      };
    },
    templateUrl: 'templates/app/brand-lists.html',
    require: '^catLists',
    restrict: 'EA',
    replace: true,
    transclude: true
...
.directive('menuLevel', function(_){
  return {
    ...
    templateUrl: 'templates/app/menu-level.html',
    require: '^pushMenu',
    restrict: 'EA',
    replace: true,
    transclude: true
